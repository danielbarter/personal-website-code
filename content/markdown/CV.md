...
## Software
- **C++** : Language of choice for programs which need to run fast. [RNMC](https://github.com/BlauGroup/RNMC) is the largest C++ program I have built. Fan of move semantics. If there is a bug, I will find it. Some of my favourite libraries and tools: sqlite, gsl, openMPI, valgrind, gdb.
...
- **Nix** : Package manager of choice. Nix Lets me say with certainty that my software will run on any computer connected to the internet. Check out my [NixOS configuration](https://github.com/danielbarter/nixos-config).
