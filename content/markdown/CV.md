...
- **Linux** : Comfortable on any linux system running systemd, bash, tmux and emacs, in particular, Debian and NixOS. Check out my [NixOS configuration](https://github.com/danielbarter/nixos-config) which specifies all my personal machines.
